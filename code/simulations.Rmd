...
# 0.02132532  0.1454363  1.320327  1.36071  -1.814676  -1.662121  -0.4872306  -0.475291
```


```{r compute_coverage}
# repeated experiments via feeding a list of testid to the function
# either the Ymodel is only fitted once and a list of testid are fed to the model, 
# or the Ymodel is fitted agian each time a new test point is supplied.

test6_coverage1<-conformal_ITE1(X=X_nt_1, Y=Y_nt_1, 
                              testid=testid0,
                              tr=Z_nt_1,
                              A=A,Atype="adj",
                              ps_pred_model="binomial",
